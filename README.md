...
The vast majority of images, diagrams, plots, and figures used in the lecture slides were created by myself or generated by me via DALLE. However, some images used in the lecture slides were sourced from web searches for aesthetic and educational purposes only. All efforts were made to use images that fall under fair use or public domain. If you believe an image has been used improperly, please contact me, and it will be promptly removed or replaced.
